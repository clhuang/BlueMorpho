...
\begin{description}
    ...
    \item[Semantic Similarity] Morphologically related words should have similar meanings. We measure the \emph{cosine similarity} between the word and its candidate parent. % TODO wordvector citation?
